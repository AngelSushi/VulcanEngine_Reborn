...
namespace VulcanCore {
    ...
    public:
       // VScriptStruct(const std::string& StructName, std::string& InFullName,size_t StructSize) : VStruct(std::move(StructName)),FullName(std::move(InFullName)), Size(StructSize) {}
