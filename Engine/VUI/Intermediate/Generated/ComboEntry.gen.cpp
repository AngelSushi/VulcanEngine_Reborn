...
void VC_Construct_VClass_ComboEntry_Statics::RegisterFunctions(VClass& c) { 
   c.AddFunction(std::make_unique<VFunction<,std::string,ReflectionBase*,VulcanCore::VProperty*,const std::vector<std::string>&>>("ResolvePropertyWidgetType", &::ResolvePropertyWidgetType)); 
}; 
